...
LDLIBSOPTIONS=`pkg-config --libs sfml-graphics` `pkg-config --libs sfml-window`  
...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `pkg-config --cflags sfml-graphics` `pkg-config --cflags sfml-window` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
